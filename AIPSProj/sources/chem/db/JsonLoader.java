...
public class JsonLoader
{
    ...
    public Drawing loadDrawing(String packedJson) throws IOException
    {
        ...
        {
            ChemicalBondModel bondModel = mapper.readValue(bondData[i], ChemicalBondModel.class);
